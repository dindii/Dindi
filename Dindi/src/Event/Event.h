...
///I'm not the biggest fan of this event system because i don't like at all using std::bind (std::function is ok performance wise)
///but i will not be making a whole event queue system just for a project that has good graphics as a goal so input responsiveness
///is not a cocern.
