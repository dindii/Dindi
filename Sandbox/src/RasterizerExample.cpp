...
void RasterizerExample::OnAttach()
{
	...
	Dindi::Model* model2 = new Dindi::Model(RESOURCES_PATH "Resources\\Models\\backpack.obj", Dindi::vec3(0.0f, 0.0f, 0.0f), 0.05f);
	Dindi::Model* model3 = new Dindi::Model(RESOURCES_PATH "Resources\\Models\\backpack.obj", Dindi::vec3(0.0f, 0.0f, 0.0f), 0.05f);
