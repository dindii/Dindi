...
#else
#define GLR_LOG_TRACE(...)   GLR::Logger::Log(GLR::Logger::Level::TRACE, __VA_ARGS__);
#define GLR_LOG_WARNING(...) GLR::Logger::Log(GLR::Logger::Level::WARNING, __LINE__, " ", __FILE__, __VA_ARGS__)
#define GLR_LOG_ERROR(...)   GLR::Logger::Log(GLR::Logger::Level::ERROR,  __LINE__, " ", __FILE__, __VA_ARGS__)
#define GLR_LOG_FATAL(...)   GLR::Logger::Log(GLR::Logger::Level::FATAL,  __LINE__, " ", __FILE__, __VA_ARGS__)
#endif
